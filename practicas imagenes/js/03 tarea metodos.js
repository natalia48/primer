...
console.log(sinespacio.join("-"));//aca entre comillas pongo como quiero q
...
let palabracapitalizada = "marmota"
console.log(palabracapitalizada.charAt(0).toUpperCase().substring(-1));
// pasarla a mayuscula
//capitalizar la palabra (marmota)significa capitalizar que la primera letra este en mayuscula 
console.log(palabracapitalizada.toUpperCase(0));
